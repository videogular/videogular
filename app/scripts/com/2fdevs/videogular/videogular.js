...
angular.module("com.2fdevs.videogular", ["ngSanitize"])
    ...
    .directive(
        "videogular", ["$window", "VG_STATES", "VG_EVENTS", "VG_UTILS",
            function($window, VG_STATES, VG_EVENTS, VG_UTILS) {
                return {
                    restrict: "E",
                    scope: {
                        playerWidth: "=vgWidth",
                    ...
                    controller: ['$scope',
                        function($scope) {
                            ...
                            this.toggleFullScreen = function() {
                                ...
                                if (!angular.element($window)[0].fullScreenAPI && !this.videoElement[0].msRequestFullscreen) {
                                    if (isFullScreen) {
                                ...
                                // Perform native full screen support
                                    ...
                                    if (this.elementScope[0].msRequestFullscreen) {
                                        if (document.msFullscreenElement) {
                                           ...
                                           this.elementScope[0].msRequestFullscreen();
                                        }

                                        // isFullScreen = !isFullScreen; // update size
                                        // $scope.updateSize();
                                    } else {
                            ...
                            $scope.init = function() {
                                ...
                                if (angular.element('videogular')[0].msRequestFullscreen) {
                            ...
                            $scope.updateSize = function() {
                                if (isPlayerReady) {
                                    ...
                                    if (angular.element($window)[0].fullScreenAPI && angular.element($window)[0].fullScreenAPI.isFullScreen() || isFullScreen || document.msFullscreenElement) {
