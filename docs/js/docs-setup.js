NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$sce active activesource api applied array automatic bigger boolean buffer buffered bufferend buffering bypercent callback callbacks called changes changesource cleans clearmedia completed config controller css cue cuepoints current currentstate currenttime custom data default define definition desired detection doesn element emulated explicitly file flag float fullscreen function http initialization inline integer isbuffering iscompleted isfullscreen islive isready json latest left list live manually media mediaelement method methods middle milliseconds mode mp4 mus native nativefullscreen normal number object objects offers oncomplete onenter onleave onupdate override param params pass pause pauses percentage plaback play playback player playing playpause plays playsinline point points position presently previous progress properties property public reach reaches reference removes representing represents resource seconds seek seeks seektime setplayback sets setstate setvolume source sources src start stops streaming string structure supply tag target theme time timelapse timeleft timeline timelines timeranges togglefullscreen toggles total totaltime tracks true trustasresourceurl trustful type updates updatetheme url user video videogular videogularelement volume"
    },
    {
      "section": "api",
